...
public class JobMain extends Configured implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        ...
        TextInputFormat.addInputPath(job, new Path("hdfs://node01:8020/input/flowdata/flow.dat"));
        ...
        TextOutputFormat.setOutputPath(job, new Path("hdfs://node01:8020/out/flowcount_partition_out"));
